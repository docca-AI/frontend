...
import { X, Mic, Stethoscope, User } from "lucide-react";
...
const AiDoccaChat = () => {
  ...
  <div className="w-full max-w-4xl mx-auto bg-white rounded-lg shadow-lg border border-gray-200 p-6">
    ...
    <div className="flex items-center justify-between gap-3 border-b border-gray-200 pb-4 mb-4">
      <div className="flex items-center gap-3">
        <div className="p-1 rounded-lg bg-primary text-white flex items-center justify-center w-9 h-9">
          <img src={Bot} alt="Ai checker" className="rounded-full w-4 h-4" />
        </div>
        <div>
          <h3 className="text-sm font-semi-bold text-primary">DOCCA Assistant</h3>
    ...
    <div className="flex justify-start gap-2 mb-4">
      <img src={Bot} alt="Ai checker" className="rounded-full w-8 h-8 flex-shrink-0" />
      <div className="bg-blue-400 rounded-lg p-4 max-w-md">
        <div className="text-white text-sm">
          Hello! I'm DOCCA, your AI health assistant. I can help you understand your 
          symptoms and guide you to the right care.
        </div>
      </div>
    </div>
    ...
    {/* Second Message - AI */}
    <div className="flex justify-start gap-2 mb-4">
      <img src="div2.png" alt="Ai checker" className="rounded-full w-8 h-8 flex-shrink-0" />
    ...
    <div className="mx-10 mb-6">
      ...
      <div className="flex flex-wrap gap-2 mb-3">
        <span className="text-xs text-gray-600 font-medium w-full">Age:</span>
      ...
      <div className="flex flex-wrap gap-2">
        <span className="text-xs text-gray-600 font-medium w-full">Gender:</span>
    ...
    <div className="flex justify-start gap-2 mb-4">
      ...
      <div className="bg-blue-400 rounded-lg p-4 max-w-md">
        <div className="text-white text-sm">
          Perfect! Now tell me about your symptoms. You can type or use the voice button to speak in English or Pidgin.
        </div>
      </div>
    </div>
    ...
    <div className="flex gap-2 mb-4">
      ...
      <button
        ...
        className="px-3 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 disabled:bg-gray-300 disabled:cursor-not-allowed transition-colors flex items-center justify-center"
      >
